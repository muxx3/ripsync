...
export default function SendPage() {
    ...
    const connectWebSocket = () => {
        ...
        console.log("Attempting WebSocket connection to: ", "wss://" + window.location.hostname + ":8000/ws");
    ...
    const sendFile = () => {
        ...
        if (wsRef.current.readyState !== WebSocket.OPEN) {
            console.warn("WebSocket not open for sending file.");
            return;
        }
        setFileSending(true);
        ...
        reader.onload = (e) => {
            ...
            // Prepare message metadata with chunk info
            const messageMeta = {
                target_id: recipientIdRef.current,
                type: "file_chunk",
